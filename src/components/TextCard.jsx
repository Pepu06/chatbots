  ...
  return (
    <div>
      <Card>
        ...
        <CardDescription>
          Generate text from images using AI models.
        </CardDescription>
      </Card>
    </div>
  );
...
const Skeleton = () => {
  return (
    <div className="flex h-full space-x-4 mb-10">
      <TextGenerateEffect
        words={
          "La generación de texto con IA crea contenido coherente y relevante mediante algoritmos que analizan patrones en datos textuales."
        }
      />
    </div>
  );
...
export const Card = ({ className, children }) => {
  return (
    <div
      className={cn(
        "max-w-sm mt-0 sm:mt-10 w-full mx-auto p-8 transition-all duration-150 hover:scale-105 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
